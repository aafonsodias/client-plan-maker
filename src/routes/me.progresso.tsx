  ...
  return (
    ...
    >
      <section className="rounded-2xl border border-border bg-card p-6 text-center">
        <TrendingUp className="mx-auto h-8 w-8 text-amber-500/70" />
        <h2 className="mt-3 text-lg font-medium">{t("progress.title")}</h2>
        <p className="mt-2 text-sm text-muted-foreground">{t("progress.soon")}</p>
      </section>
    </MeShell>
  );
}