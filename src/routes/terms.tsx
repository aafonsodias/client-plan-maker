...
export const Route = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: [
      { title: "Terms · Forge" },
      { name: "description", content: "Terms of service for Forge." },
    ],
  }),
});
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 prose prose-invert">
        ...
        <div className="mt-8 space-y-5 text-[15px] leading-[1.7] text-foreground/85">
          <p>
            These terms govern your use of Forge ("the Service"). By creating an account
          ...
          you generate, edit, or deliver to a client through Forge. Forge provides tooling,
          ...
          <p>The Service is provided "as is". To the maximum extent permitted by law, Forge
